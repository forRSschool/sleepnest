      ...
      <div className="card-info">
        ...
        <div className="card-info__description">
          ...
          <table className="single__left-table">
            <tbody>
              <tr>
                <td className="single__left-td">Material:</td>
                <td className="single__left-td">100% Cotton Flannel</td>
              </tr>
              <tr>
                <td className="single__left-td">Pillowcase:</td>
              ...
              <tr>
                <td className="single__left-td">Size:</td>
      ...
      <div className="single-product__similar-products">
        ...
        {similarProducts.map(item => (
            <li className="product__list-item" key={item.id}>
              ...
              <p className="product__list-text">{item.title}</p>
            </li>
          ))}
        </ul>
      </div>
